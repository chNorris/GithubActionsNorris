[![Run App ChristianNorris](https://github.com/chNorris/GithubActionsNorris/actions/workflows/run-app.yaml/badge.svg)](https://github.com/chNorris/GithubActionsNorris/actions/workflows/run-app.yaml)
